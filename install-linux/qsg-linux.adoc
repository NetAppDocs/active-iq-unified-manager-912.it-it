...
* Sistema operativo: Red Hat Enterprise Linux versioni 7.x e da 8.0 a 8.6, o CentOS versione 7.x basato sull'architettura x86_64, installato utilizzando l'ambiente di base "Server with GUI" dall'opzione *Software Selection* del programma di installazione del sistema operativo
